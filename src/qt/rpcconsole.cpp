                                          ...
                                          banTableContextMenu(0)
{
    ...
    if(!strzAGRPathCustom.empty()) {
        ui->wallet_customzagrbackuppath->setText(QString::fromStdString(strzAGRPathCustom));
        ui->wallet_customzagrbackuppath_label->setVisible(true);
        ui->wallet_customzagrbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzAGRPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Agrarian RPC console.") + "<br>" +
