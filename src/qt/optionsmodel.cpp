...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::AGR);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeAgrarianAmount"))
        SoftSetArg("-anonymizeagrarianamount", settings.value("nAnonymizeAgrarianAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in agrarian.cpp during shotdown to also remove the window positions
